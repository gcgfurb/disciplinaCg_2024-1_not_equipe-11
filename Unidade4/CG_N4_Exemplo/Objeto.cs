...
namespace gcgcg
{
    internal class Objeto  // TODO: deveria ser uma class abstract ..??
    {
        ...
        public List<Ponto4D> _texturePoints = [];
        ...
        public void ObjetoAtualizar()
        {
            ...
            float[] textureVertices = new float[_texturePoints.Count * 2];
            ...
            var localVertices = _shaderObjeto.GetAttribLocation("aPosition");
            GL.VertexAttribPointer(localVertices, 3, VertexAttribPointerType.Float, false, 3 * sizeof(float), 0);
            GL.EnableVertexAttribArray(localVertices);
